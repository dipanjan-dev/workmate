        ...
        <div class="page-body">
          <div class="container-xl">
            <div class="row mb-3 justify-content-end">
              <div class="col-lg-4">
                <div class="search">
                  <form action="/search-token" method="POST" class="d-flex">
                    <input type="text" class="form-control mr-3" placeholder="Search by Token Number or Token Id or Employee Name or Id" name="searchtoken">
                    <button class="btn ml-3" type="submit">Search</button>
                  </form>
                </div>
              </div>
            </div>
