<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <c:if test="${not empty userInfo}">
        ...
        <head>
            ...
            <title>${tokendetails.getToken_Number()} - ${tokendetails.getToken_id()} - ${tokendetails.getName()} -
                ${tokendetails.getUserId()}</title>
            <!-- CSS files -->
                ...
                <div class="page-wrapper">
                    <div class="container-xl">
                        ...
                        <div class="d-flex mt-3 mb-3 justify-content-between  d-print-none">
                            <div class="back-btn">
                                <a href="/all-token" class="btn btn-outline-secondary">Back</a>
                            </div>
                            <div class="print">
                        ...
                        <div class="card pt-4 pb-4">
                            <div class="container">
                                <form action="/update/token/${tokendetails.getToken_Number()}" method="POST">
                                   <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="Status">
                                          ...
                                          <option value="Paperwork Made">Paperwork Made</option>
                                          <option value="Assign to Specific Department">Assign to Specific Department</option>
                                          <option value="Resolved">Resolved</option>
                                        </select>
                                      </div>
                                </div>
                                <div class="col-lg-6">
                                    <label class="form-label">Any Specific Name</label>
