                ...
                <div class="col-md-6 col-lg-3 col-12">
                    <div class="card">
                      <div class="card-body p-4 text-center">
                        <span class="avatar avatar-xl mb-3 avatar-rounded">${alluser.getName().charAt(0)}</span>
                        <h3 class="m-0 mb-1"><a href="/view/${alluser.getId()}">${alluser.getName()}</a></h3>
                        <div class="text-muted">${alluser.getEmployeeRole()}</div>
                        <div class="mt-3">
                          <c:if test="${alluser.getUserType()=='Admin'}">
                            <span class="badge bg-success">${alluser.getUserType()}</span>
                          </c:if>
                          <c:if test="${alluser.getUserType()=='Employee'}">
                            <span class="badge bg-primary">${alluser.getUserType()}</span>
                          </c:if>
                          <c:if test="${alluser.getUserType()=='Super'}">
                            <span class="badge bg-success">${alluser.getUserType()}</span>
                          </c:if>
                        </div>
                      </div>
                      <div class="d-flex">
                        <a href="mailto:${alluser.getEmail()}" class="card-btn">
                          ...
                          Email</a>
                        <!-- <a href="#" class="card-btn" style=" pointer-events: fill; cursor: not-allowed;">
        ...
        <form class="modal-content"  method="POST" action="/register-user"  modelAttribute="Users">
          ...
          <div class="modal-body">
            ...
            <div class="form-selectgroup-boxes row mb-3">
              ...
              <div class="col-lg-6">
                <label class="form-selectgroup-item">
                  <input type="radio" name="report-type" value="Employee" class="form-selectgroup-input">
                  <span class="form-selectgroup-label d-flex align-items-center p-3">
                    <span class="me-3">
                      <span class="form-selectgroup-check"></span>
                    </span>
                    <span class="form-selectgroup-label-content">
                      <span class="form-selectgroup-title strong mb-1">Employee</span>
                    </span>
                  </span>
                </label>
              </div>
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="RepeatPassword" placeholder="Retype Password">
              </div>
