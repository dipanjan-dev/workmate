                                ...
                                <div class="card">
                                  <div class="table-responsive">
                                    <table class="table table-vcenter table-mobile-md card-table shadow">
                                      ...
                                      <tbody>
                                        <c:forEach var="EmID" items="${EmID}">
                                        <tr>
                                          <td data-label="Name" >
                                            <div class="d-flex py-1 align-items-center">
                                                <span class="avatar avatar-sm me-2">${EmID.getName().charAt(0)}</span>
                                              <div class="flex-fill">
                                                <div class="font-weight-medium">${EmID.getName()}</div>
                                              </div>
                                            </div>
                                          </td>
                                          <td data-label="Title" >
                                            <div>${EmID.getEmail()}</div>
                                          </td>
                                          <td class="text-muted" data-label="Role" >
                                            <div>${EmID.getUserId()}</div>
                                          </td>
                                          <td class="text-muted" data-label="Role" >
                                            <div>${EmID.getEmployeeRole()}</div>
                                          </td>
                                          <td data-label="Role" >
                                            <a href="/view/${EmID.getId()}" class="btn">
                                              View Employee
                                            </a>
                                          </td>
                                        </tr>
